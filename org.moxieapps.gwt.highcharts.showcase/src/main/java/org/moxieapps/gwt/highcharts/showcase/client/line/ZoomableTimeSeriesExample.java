...
public class ZoomableTimeSeriesExample extends BaseChartExample {

    public ZoomableTimeSeriesExample(String title, String icon) {
        super(title, icon);
    }

    @Override
    public String getSourcePath() {
        return "line/ZoomableTimeSeriesExample.java.html";
    }
    ...
    public static ExampleFactory getFactory() {
        return new ExampleFactory() {
            ...
            public Canvas createChartCanvas() {
                return new ZoomableTimeSeriesExample(getTitle(), getIcon());
            }
        ...
        final Chart chart = new Chart()
            ...
            .setAreaPlotOptions(new AreaPlotOptions()
                .setFillColor(new Color()
                    ...
                    // TODO: Need a way to retrieve the theme color instead, e.g. Highcharts.theme.colors[0]
