...
public class MultipleSeriesExample extends BaseChartExample {

    public MultipleSeriesExample(String title, String icon) {
        super(title, icon);
    }

    @Override
    public String getSourcePath() {
        return "stock/MultipleSeriesExample.java.html";
    }
    ...
    public static ExampleFactory getFactory() {
        return new ExampleFactory() {
            ...
            public Canvas createChartCanvas() {
                return new MultipleSeriesExample(getTitle(), getIcon());
            }

            @Override
            public String getTitle() {
                return "Multi Line Stock Values";
            }
    ...
    public static Number[][] getAAPLData() {

        Number[][] AAPLData = new Number[][]{
                {t(2006, 7, 20), 60.72},
                {t(2006, 7, 23), 61.42},
                {t(2006, 7, 24), 61.93},
                {t(2006, 7, 25), 63.87},
    ...
    public static Number[][] getMSFTData() {

        Number[][] MSFTData = new Number[][]{
                {t(2006, 7, 20), 390.11},
                {t(2006, 7, 23), 390.9},
                {t(2006, 7, 24), 389.36},
                {t(2006, 7, 25), 385.5},
    ...
    public static Number[][] getGOOGData() {

        Number[][] GOOGData = new Number[][]{
                {t(2006, 7, 20), 23.87},
                {t(2006, 7, 23), 24.0},
                {t(2006, 7, 24), 24.22},
                {t(2006, 7, 25), 24.37},
    ...
    public BaseChart createChart() {
        ...
        final StockChart chart = new StockChart()
                ...
                .setLinePlotOptions(
                        new LinePlotOptions()
                                .setCompare(LinePlotOptions.Compare.PERCENT)
                )
                .setToolTip(
                        new ToolTip()
                                ...
                                .setFormatter(
                                        new AxisLabelsFormatter() {
                                            public String format(AxisLabelsData axisLabelsData) {
                                                return (axisLabelsData.getValueAsLong() > 0 ? "+" : "") + axisLabelsData.getValueAsLong() + "%";
                                            }
                                        }
                                )
                )
        ...
        chart.addSeries(
                chart.createSeries()
                        .setName("AAPL")
                        .setPoints(getAAPLData())
        )
                .addSeries(
                        chart.createSeries()
                                .setName("GOOG")
                                .setPoints(getGOOGData())
                )
                .addSeries(
                        chart.createSeries()
                                .setName("MSFT")
                                .setPoints(getMSFTData())
                )
        ;
