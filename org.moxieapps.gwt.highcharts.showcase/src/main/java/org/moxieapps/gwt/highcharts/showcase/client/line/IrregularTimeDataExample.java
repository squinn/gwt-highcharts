...
public class IrregularTimeDataExample extends BaseChartExample {

    public IrregularTimeDataExample(String title, String icon) {
        super(title, icon);
    }

    @Override
    public String getSourcePath() {
        return "line/IrregularTimeDataExample.java.html";
    }
    ...
    public static ExampleFactory getFactory() {
        return new ExampleFactory() {
            ...
            public Canvas createChartCanvas() {
                return new IrregularTimeDataExample(getTitle(), getIcon());
            }
